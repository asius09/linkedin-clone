        ...
        <div className="p-4 border-b border-border dark:border-border-dark">
          ...
          <div className="mt-2 relative">
            <input
              ...
              className="w-full p-2 pl-8 rounded-md bg-input-bg dark:bg-input-bg-dark text-primary-text dark:text-primary-text-dark"
            />
            <i className="ri-search-line absolute left-2 top-3 text-secondary-text dark:text-secondary-text-dark"></i>
          </div>
        </div>
