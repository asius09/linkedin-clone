    ...
    <div className="bg-secondary-bg dark:bg-secondary-bg-dark rounded-lg border border-border dark:border-border-dark shadow-sm p-4 mb-4">
      ...
      <div className="space-y-4">
        {pendingInvitations.map((invitation) => (
          <div
            key={invitation.id}
            className="flex items-start justify-center border-b border-gray-100 dark:border-gray-800 pb-4 last:border-0 last:pb-0"
          >
            <img
              src={invitation.img}
              alt={invitation.name}
              className="w-18 h-18 rounded-full object-cover mr-3"
            />
