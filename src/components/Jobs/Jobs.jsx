        ...
        <div className="bg-secondary-bg dark:bg-secondary-bg-dark rounded-lg border border-border dark:border-border-dark shadow-sm p-4">
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full bg-input-bg dark:bg-input-bg-dark rounded-md py-2 px-4 pl-10 text-sm border border-border dark:border-border-dark"
            />
        ...
        <div className="bg-secondary-bg dark:bg-secondary-bg-dark rounded-lg border border-border dark:border-border-dark shadow-sm p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-2">
              <select
                ...
                className="bg-input-bg dark:bg-input-bg-dark border border-border dark:border-border-dark rounded-md py-1 px-2 text-sm"
              >
          ...
          <div className="space-y-4">
            {featuredJobs.map((job) => (
              <div
                key={job.id}
                className="border border-border dark:border-border-dark rounded-lg p-4 hover:shadow-md transition-shadow"
              >
