...
import { toggleTheme, toggleThemeCard } from "../features/themeSlice";
...
const LanguageAndTheme = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black/50 absolute inset-0 z-50">
